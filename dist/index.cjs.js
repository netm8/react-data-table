...
function mapColumnsToCells(columns) {
    return columns.map(function (column, idx) { return (React__default['default'].createElement("th", { key: column.label + "." + idx },
        column.label,
...
function TableHead() {
    ...
    return (React__default['default'].createElement("thead", null,
        React__default['default'].createElement("tr", null,
            ...
            actions && React__default['default'].createElement("th", null, "Actions"))));
}
...
function mapColumnsToRows(columns, data) {
    return data.map(function (row, rowIdx) { return (React__default['default'].createElement("tr", { key: rowIdx }, columns.map(function (column, columnIdx) {
        var accessor = column.accessor;
        var data = parseAccessor(accessor, row);
        return React__default['default'].createElement("td", { key: rowIdx + "." + columnIdx }, data);
    }))); });
}
function TableBody() {
    var _a = React.useContext(DataTableContext), data = _a.data, columns = _a.columns;
    return React__default['default'].createElement("tbody", null, mapColumnsToRows(columns, data));
}
...
function DataTable(_a) {
    ...
    return (React__default['default'].createElement(Provider, { actions: actions, columns: columns, filters: filters, pagination: pagination, provider: provider },
        React__default['default'].createElement("div", { className: styles.DataTableWrapper },
