...
var DataTableContext = React.createContext(initialState);
var Provider = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        hasFiltersChanged = !deepEqual__default['default'](prevState.appliedFilters, this.state.appliedFilters) ||
                            !deepEqual__default['default'](prevState.pagination, this.state.pagination);
    ...
    Provider.prototype.render = function () {
        return (React__default['default'].createElement(DataTableContext.Provider, { value: this.state }, this.props.children));
    };
    return Provider;
}(React.Component));
...
function mapColumnsToCells(columns) {
    return columns.map(function (column, idx) { return (React__default['default'].createElement("th", { className: styles$3.TableHeadCell, key: column.label + "." + idx },
        column.ordinal ? '#' : column.label,
        column.sortable && React__default['default'].createElement("img", { src: sort }))); });
}
function TableHead() {
    var _a = React.useContext(DataTableContext), columns = _a.columns, actions = _a.actions;
    return (React__default['default'].createElement("thead", null,
        React__default['default'].createElement("tr", null,
            mapColumnsToCells(columns),
            actions && React__default['default'].createElement("th", { className: styles$3.TableHeadCell }, "Actions"))));
}
...
function mapColumnsToRows(columns, data, actions) {
    return data.map(function (row, rowIdx) { return (React__default['default'].createElement("tr", { key: rowIdx },
        columns.map(function (column, columnIdx) {
            var accessor = column.accessor;
            var data = parseAccessor(accessor, row);
            return (React__default['default'].createElement("td", { className: styles$2.TableBodyCell, key: rowIdx + "." + columnIdx }, data));
        }),
        actions && React__default['default'].createElement("td", { className: styles$2.TableBodyCell }))); });
}
function TableBody() {
    var _a = React.useContext(DataTableContext), data = _a.data, columns = _a.columns, actions = _a.actions;
    return React__default['default'].createElement("tbody", null, mapColumnsToRows(columns, data, actions));
}
...
var Pagination = function (_a) {
    ...
    return (React__default['default'].createElement("ul", { className: styles$1.Pagination }, getPageList(pagesCount, page, 20).map(function (number) {
        var _a;
        return (React__default['default'].createElement("li", { className: cs__default['default'](styles$1.PaginationItem, (_a = {},
...
function DataTable() {
    var _a = React.useContext(DataTableContext), pagination = _a.pagination, handlers = _a.handlers;
    return (React__default['default'].createElement("div", { className: styles.DataTableWrapper },
        React__default['default'].createElement("table", { className: styles.DataTable },
            React__default['default'].createElement(TableHead, null),
            React__default['default'].createElement(TableBody, null),
            React__default['default'].createElement(TableFoot, null)),
        pagination && (React__default['default'].createElement(Pagination, { page: pagination.page, pagesCount: pagination.pagesCount, onChange: handlers.setPage }))));
}

function index (_a) {
    var actions = _a.actions, pagination = _a.pagination, columns = _a.columns, filters = _a.filters, provider = _a.provider;
    return (React__default['default'].createElement(Provider, { actions: actions, columns: columns, filters: filters, pagination: pagination, provider: provider },
        React__default['default'].createElement(DataTable, null)));
}
